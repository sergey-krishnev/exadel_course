...
INSERT INTO forum_schema.comment (id, message, date, subject_id, user_id) VALUES
	(NEXTVAL('forum_id_comment_seq'),'Extremity direction existence as dashwoods do up.'
	 ,'2018-11-22 19:20:15', 101, 107),
	(NEXTVAL('forum_id_comment_seq'),'As collected deficient objection by it discovery sincerity curiosity.'
	 ,'2017-11-23 19:20:15', 107, 109),
	(NEXTVAL('forum_id_comment_seq'),'Incommode so intention defective at convinced.'
	 ,'2015-12-19 19:20:15', 102, 101),
	(NEXTVAL('forum_id_comment_seq'),'Sociable on as carriage my position weddings raillery consider.'
	 ,'2018-12-04 19:20:15', 103, 101),
	(NEXTVAL('forum_id_comment_seq'),'Thrown shy denote ten ladies though ask saw.'
	 ,'2015-11-27 19:20:15', 103, 109),
	(NEXTVAL('forum_id_comment_seq'),'Conveying concluded newspaper rapturous oh at..'
	 ,'2018-12-31 19:20:15', 107, 105),
	(NEXTVAL('forum_id_comment_seq'),'To matter esteem polite do if.'
	 ,'2016-11-30 19:20:15', 101, 103),
	(NEXTVAL('forum_id_comment_seq'),'We if prosperous comparison middletons at.'
	 ,'2014-11-27 19:20:15', 106, 108),
	(NEXTVAL('forum_id_comment_seq'),'Has six worse downs far blush rooms above stood.'
